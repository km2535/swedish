      ...
      <div className={styles.container}>
        ...
        <p className="lh6 bs4">
          ...
          <span className="spanphasis">
            ...
            등 「개인정보 보호법」 또한 민호텔은 개인정보를 제 3자에게 제공하지
            않습니다.
          </span>
        </p>
        <span className="spanphasis">
          ...
          <p className="sub_p">
            <span className="spanphasis">
              ...
              수 있으며 민호텔은(는) 이에 대해 지체 없이 조치하겠습니다.
            </span>
          </p>
          <p className="sub_p">
            <span className="spanphasis">
          ...
          <span className="spanphasis">
            ...
            <span className="spanphasis">
              ...
              <p className="sub_p mgt10">
                <span className="spanphasis">
                  {" "}
                  ① <span className="colorLightBlue">민호텔</span> 은(는)
              ...
              <ul className="list_indent2 mgt10">
                ...
                <li>
                  <span className="spanphasis">성명 :이강민</span>
                </li>
                <li>
                ...
                <li>
                  <span className="spanphasis">
                    연락처 :010-2074-3280, lkm1416@gamil.com
                  </span>
                </li>
              </ul>
              <p className="sub_p">
              ...
              <ul className="list_indent2 mgt10">
                ...
                <li>
                  <span className="spanphasis">연락처 : 010-2074-3280</span>
                </li>
              </ul>
              <p className="sub_p">
                <span className="spanphasis">
                  ...
                  있습니다. 민호텔 은(는) 정보주체의 문의에 대해 지체 없이 답변
                  및 처리해드릴 것입니다.
                </span>
              </p>
              <span className="spanphasis">
